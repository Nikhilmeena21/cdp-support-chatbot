...
class ZeotapScraper(BaseScraper):
    ...
    def extract_content(self, soup):
        """Extract the main content from a Zeotap docs page"""
        main_content = soup.find('div', class_='documentation')
        if not main_content:
    ...
    def scrape(self, max_pages=20):  # Smaller limit for testing
        ...
        while to_visit and page_count < max_pages:
            ...
            try:
                ...
                for link in soup.find_all('a', href=True):
                    href = link['href']
                    if 'docs.zeotap.com' in href or href.startswith('/'):
